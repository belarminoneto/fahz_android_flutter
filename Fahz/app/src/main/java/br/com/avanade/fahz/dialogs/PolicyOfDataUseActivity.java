...
public class PolicyOfDataUseActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_terms_policy_data_use);
    ...
    public void cancel() {
        ...
        int resID;
        resID = getResources().getIdentifier("MSG504", "string", getPackageName());
    ...
    private void getTerm() {
        ...
        Call<PolicyResponse> call = mAPIService.getDataUsagePolicy();
            ...
            public void onResponse(@NonNull Call<PolicyResponse> call, @NonNull Response<PolicyResponse> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (policyResponse != null && policyResponse.hasMessage()) {
                        ...
                        FirstAccessFragment.idTermOfAcceptanceDataUse = policyResponse.getPolicy().versionPanelId;
                    }
                } else {
